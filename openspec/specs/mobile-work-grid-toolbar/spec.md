---
id: mobile-work-grid-toolbar
title: mobile-work-grid-toolbar
overview: "Sticky toolbar, bottom-sheet genre filters, and responsive grid columns for the WorkGrid page on mobile viewports."
requirementCount: 3
---

# mobile-work-grid-toolbar Specification

## Purpose
Adapts the WorkGrid toolbar and genre filter UI for mobile viewports (< 768px) with sticky positioning, a bottom-sheet filter panel, and guarantees at least two grid columns at all widths.
