...
The endpoint SHALL create a Work file linked to the resolved authors, an Edition file linked to the Work, and a Copy file linked to both the Edition and Work. Optional fields that are not provided SHALL be omitted from the created entities.
