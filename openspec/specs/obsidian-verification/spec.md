# obsidian-verification Specification

## Purpose
Automated verification using the Obsidian CLI to confirm the markdown library works as a functional Obsidian vault. Includes documentation for Obsidian users.
