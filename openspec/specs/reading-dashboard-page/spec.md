# reading-dashboard-page Specification

## Purpose
Client home page that renders the reading dashboard at `/`, presenting currently-reading cards with inline actions, a reading-at-a-glance strip, and recently-finished and recently-added sections.
