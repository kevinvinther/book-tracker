# dark-mode-provider Specification

## Purpose
React context and hook for three-state theme management (light/dark/system), with system preference tracking, localStorage persistence, and `.dark` class sync on `<html>`.
## Requirements
