...
## Purpose
The backend serves the built single-page app and its assets on the same origin and port as the API, with history-mode fallback that never intercepts `/api` routes.
