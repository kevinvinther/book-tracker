# work-merge Specification

## Purpose
Backend capability that combines two Works into one by re-parenting the loser's dependent entities (Editions, Copies, Notes) onto the winner, absorbing the loser's metadata into the winner, and deleting the loser Work file.
