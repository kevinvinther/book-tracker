...
## Purpose
Provides a fixed bottom navigation bar on mobile viewports (< 768px) with four tabs (Grid, Stats, Add, Settings), hides desktop header links, and handles safe area insets for notched devices.
