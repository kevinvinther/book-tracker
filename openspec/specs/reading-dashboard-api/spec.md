# reading-dashboard-api Specification

## Purpose
Define the REST API that assembles the reading dashboard data (currently reading, recently finished, recently added, and glance numbers) from the in-memory index in a single response.
