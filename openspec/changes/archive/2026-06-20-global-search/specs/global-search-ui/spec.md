...
### Requirement: Search bar visible in app header

The application SHALL display a search input field in the header navigation bar, visible on every page.

#### Scenario: Header search bar is present on all pages
